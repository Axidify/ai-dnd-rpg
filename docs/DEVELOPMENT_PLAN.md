...
| 2.4 | Combat Integration | Integrate combat into main game with AI triggers | 🔄 In Progress |
| 2.5 | Inventory System | Pick up items, use items, equip gear | ⬜ |
...
- [ ] Combat works seamlessly in main game
