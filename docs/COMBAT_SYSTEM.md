...
**Extracted from:** DEVELOPER_GUIDE.md  
**Last Updated:** December 26, 2025

This document contains the complete combat system documentation for the AI D&D Text RPG.
...
4. Display shows: `ðŸ’¥ Damage: [6]+3 + ðŸ§ª[3] poison = 12`
...
#### Display Format
```
ðŸ›¡ï¸ Marcus attacks Goblin: [17]+5 = 22 vs AC 12 â†’ âœ… HIT! 8 damage!
ðŸ¹ Elira âš”ï¸ FLANKING attacks Goblin: [11, 14â†’14]+5 = 19 vs AC 12 â†’ âœ… HIT! 10 damage!
```
...
| `display_combat_narration(narration)` | Displays ðŸ“– narration with proper formatting |
...
```
ðŸ—¡ï¸ Attack (Longsword): [17]+5 = 22 vs AC 15 = âœ… HIT!
ðŸ’¥ Damage: [6]+3 = 9 slashing damage

ðŸ“– Your blade arcs through the air in a deadly silver flash. The goblin 
...
| `get_items_display()` | Returns "ðŸŽ’ Items here: torch, sword" |
| `get_npcs_display()` | Returns "ðŸ‘¤ Present: Barkeep, Bram" |
...
location.get_items_display()  # "ðŸŽ’ Items here: Healing Potion, Torch"
location.get_npcs_display()   # "ðŸ‘¤ Present: Bram, Barkeep"
...
for hint in hints:
    print(f"ðŸ’¡ {hint}")  # "The vines look unusually thick..."
```
...
class Location:
    ...
    map_icon: str = "ðŸ "            # Emoji/icon for marker
...
GOBLIN_CAVE_MAP_DATA = {
    ...
    "tavern_main":     {"x": 0.15, "y": 0.12, "icon": "ðŸº"},
    "village_square":  {"x": 0.50, "y": 0.12, "icon": "ðŸ›ï¸"},
    "blacksmith_shop": {"x": 0.85, "y": 0.12, "icon": "ðŸ› ï¸"},
    
    # Forest Region (y: 0.25 - 0.55)
    "forest_path":     {"x": 0.50, "y": 0.38, "icon": "ðŸŒ²"},
    "forest_clearing": {"x": 0.35, "y": 0.52, "icon": "ðŸŒ³"},
    "cave_entrance":   {"x": 0.65, "y": 0.52, "icon": "ðŸ’€"},
    
    # Cave Region (y: 0.55 - 1.0)
    "cave_tunnel":     {"x": 0.35, "y": 0.70, "icon": "ðŸ•¯ï¸"},
    "goblin_camp":     {"x": 0.65, "y": 0.70, "icon": "âš”ï¸"},
    "storage_room":    {"x": 0.35, "y": 0.88, "icon": "ðŸ“¦"},
    "boss_chamber":    {"x": 0.65, "y": 0.88, "icon": "ðŸ‘‘"}
}
```
...
|-------|-------|-------|----------|
| `hostile` | < -50 | ðŸ”´ | Refuses trade, may attack |
| `unfriendly` | -50 to -10 | ðŸŸ  | +25% prices, limited dialogue |
| `neutral` | -10 to +10 | ðŸŸ¡ | Normal prices and interactions |
| `friendly` | +10 to +50 | ðŸŸ¢ | -10% discount, extra dialogue |
| `trusted` | > +50 | ðŸ”µ | -20% discount, special quests |
...
npc.get_disposition_label()     # Returns: "ðŸŸ¢ Friendly (+35)"
...
â”‚ ðŸ›’ Gavin's Forge                                        â”‚
â”‚ ðŸ’° Your Gold: 100                                       â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ âœ¨ Haggle Discount: 20% off!                            â”‚
â”‚ ðŸ¤ Friendly Discount: 10% off                           â”‚
â”‚                                                          â”‚
â”‚ FOR SALE:                                                â”‚
...
> ðŸ“„ **Template Available**: Copy `docs/SCENARIO_TEMPLATE.py` to `src/` as your starting point.
